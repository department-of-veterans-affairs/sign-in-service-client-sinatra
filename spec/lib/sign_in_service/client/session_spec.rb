...
RSpec.describe SignInService::Client::Session do
  ...
  let(:token_type) { 'some-type' }
  let(:client) { SignInService::Client.new(base_url:, client_id:, token_type:) }
  ...
  describe '#introspect' do
    ...
    context 'when using a cookie token type' do
    ...
    context 'when using a bearer token type' do
